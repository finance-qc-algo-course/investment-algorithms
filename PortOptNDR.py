...
class PortfolioOptimizer(BaseEstimator):
    ...
    def __init__(self, R=2e-3, is_PCA=False, is_kenrel_PCA=False, is_MCD=False, n_components=1, n_top_companies=20,
                 ...
                 is_PCA_preprocessing=False, preprocessing_kept_dim=1, is_NDR=False, is_NPCA=False, is_NMF=False,
                 ndr_n_comp=2, ndr_window_size=5):
        '''
        ...
        self.is_NMF = is_NMF
        self.ndr_n_comp = ndr_n_comp
        self.ndr_window_size = ndr_window_size
